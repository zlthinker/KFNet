...
* **Input:** The input folder of a project should contain the files below.
	...
	* We can download the prepared input files of the `fire` scene of [7scenes](https://www.microsoft.com/en-us/research/project/rgb-d-dataset-7-scenes/) from the [Google drive link](https://drive.google.com/file/d/1EaVPg_-6gp_7PWvsiHk05QHU425t5dql/view?usp=sharing) for a try.
